...
```bash
git clone https://github.com/mak3r/corne-kbd-hud
cd corne-kbd-hud
...
*(Keep this table's rows in sync with the identical copy in `corne-kbd-hud`'s own `docs/HUD.md` whenever a new paired release goes out on either side.)*
